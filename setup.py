...
setup(
    ...
    long_description='\n'.join(DOCLINES[2:]),
    author='Luca Garello',
    author_email='luca.garello@iit.it',
    url='https://github.com/MissingSignal/Tensorflow-models',
    download_url='https://github.com/MissingSignal/Tensorflow-models/tags',
    license='Apache 2.0',
